...
namespace BankingXamarin.Services
{
    ...
    public class MonkeyDatabase
    {
        ...
        {
            if (_database.Table<Monkey>().Count() == 0)
            {
        ...
        {
            var monkeys = _database.Table<Monkey>().ToList();
